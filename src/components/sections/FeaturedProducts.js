...
//   return (
//     <section className="py-16 bg-gradient-to-b from-blue-50 to-blue-50">
//       <div className="container mx-auto px-4">
//         <div className="text-center mb-12">
//           <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 border border-blue-200 shadow-sm mb-4">
//             <span className="text-sm text-blue-700 font-medium">Our Flagship Products</span>
//           </div>
...
//           <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl hover:scale-105 transition-all duration-300 font-semibold text-lg shadow-lg shadow-blue-200">
...
export function FeaturedProducts() {
  ...
  return (
    <section ref={ref} className="py-16 bg-gradient-to-b from-blue-50 to-blue-50">
      <div className="container mx-auto px-4">
        <motion.div 
        ...
        >
          <motion.div 
            ...
            className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 border border-blue-200 shadow-sm mb-4"
          >
            <span className="text-sm text-blue-700 font-medium">Our Flagship Products</span>
          </motion.div>
          <motion.h2 
