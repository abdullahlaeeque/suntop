...
const distributors = [
  ...
  {
    id: 2,
    name: 'Sugarwell Solutions',
    contact: '+91 9111243182',
    location: 'Bhopal,Indore, Ujjain , baadi , hoshangabad, MP',
    contactPerson: 'Mariya Siddiqui'
  },
  {
    id: 2,
    name: 'Medico Trader',
...
export default function DistributorsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-200 to-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-blue-500 to-blue-700 text-white pt-40 py-16">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {distributors.map((distributor) => (
              <div
                key={distributor.id}
                className="bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group hover:transform hover:scale-105"
              >
                {/* Card Header */}
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="bg-blue-100 rounded-lg p-2 flex-shrink-0 mt-1">
